...
export default function FeaturesSection() {
  return (
    <section id="features" className="py-32 bg-landing-cream relative border-t border-landing-clay overflow-hidden">
      ...
      <div className="container mx-auto px-6 sm:px-8 lg:px-12 max-w-7xl relative z-10">
        <div className="mb-24 md:w-2/3">
          <motion.h2
            ...
            className="text-5xl md:text-7xl font-black text-landing-espresso uppercase tracking-tighter leading-[0.9]"
          >
            Built for Two
          </motion.h2>
          <motion.p
            ...
            className="text-landing-espresso-light text-lg mt-4 max-w-lg"
          >
        ...
        <div className="grid grid-cols-12 gap-6 md:gap-8">
          {features.map((feature, index) => (
            <motion.div
              ...
              className={`${feature.colSpan} ${feature.offset} bg-white p-8 md:p-12 border-l-4 ${feature.color} transition-all duration-500 hover:bg-landing-sand hover:-translate-y-2 group shadow-sm`}
            >
              <div className="mb-8 opacity-40 group-hover:opacity-100 transition-opacity duration-300 text-landing-espresso">
                {feature.icon}
              </div>
              <h3 className="text-3xl lg:text-4xl font-black text-landing-espresso mb-6 tracking-tight uppercase leading-none">
                {feature.title}
              </h3>
              <p className="text-landing-espresso-light group-hover:text-landing-espresso text-lg leading-relaxed font-medium">
                {feature.description}
              </p>
            </motion.div>
          ))}
