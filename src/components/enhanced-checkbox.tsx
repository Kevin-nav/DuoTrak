      ...
      <AnimatePresence>
        {showDiscouragement && (
          <motion.div
            ...
            className="absolute -top-16 left-1/2 transform -translate-x-1/2 bg-error-red text-white px-4 py-2 rounded-lg text-xs font-medium whitespace-nowrap z-50 shadow-lg"
