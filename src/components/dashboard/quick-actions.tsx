...
import { Plus, List, Users, UserPlus } from "lucide-react"
...
export default function QuickActions({ hasPartner = false }: QuickActionsProps) {
  ...
  const actions = [
    ...
    {
      id: "partner-action",
      label: hasPartner ? "Manage Partner" : "Invite a Partner",
      icon: hasPartner ? Users : UserPlus,
      description: hasPartner ? "View partner settings" : "Find someone to share goals with",
    },
  ]
