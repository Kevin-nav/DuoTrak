  ...
  return (
    <div className="relative z-10">
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        className={`${sizeClasses[size]} relative rounded-md border-2 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-primary-blue/50 ${
          checked
            ? "bg-primary-blue border-primary-blue text-white shadow-lg shadow-primary-blue/25"
            : "border-cool-gray dark:border-gray-600 hover:border-primary-blue dark:hover:border-primary-blue bg-white dark:bg-gray-800"
        }`}
      >
        ...
        {checked && (
          <motion.div
            ...
            className="absolute inset-0 bg-primary-blue rounded-md blur-sm -z-10"
          />
        )}
        ...
        {!checked && isHovering && (
          ...
          >
            <motion.div
              ...
              className="w-2 h-2 bg-primary-blue/40 rounded-full"
            />
          </motion.div>
        )}
      </motion.button>
      ...
      <AnimatePresence>
        {showDiscouragement && (
          <motion.div
            ...
            className="absolute bottom-full left-1/2 mb-2 w-max max-w-[220px] -translate-x-1/2 transform rounded-lg bg-error-red px-4 py-2 text-center text-xs font-medium text-white shadow-lg z-50"
          >
            <motion.div
            ...
            {/* Tooltip arrow */}
            <div className="absolute top-full left-1/2 transform -translate-x-1/2 w-0 h-0 border-l-4 border-r-4 border-t-4 border-transparent border-t-error-red" />
