...
class JudgeAgent:
    def __init__(self):
        ...
        **TASK:**
        ...
        - A `reasoning` string that provides a brief, objective justification for your scores, highlighting specific strengths and weaknesses.
        """

    async def evaluate_plan(self, user_profile: Dict, goal_context: str, user_answers: Dict, plan: Dict) -> Dict[str, Any]:
        ...
        result = await gemini_manager.execute_with_model(
            model_type='pro', # Use the more powerful model for evaluation
        ...
        if not result['success']:
            ...
            return {"final_score": 0, "reasoning": "Judge agent failed to execute."}
