...
class QuestionAgent:
    def __init__(self):
        ...
        TASK: Based on the user's profile and their new goal context, select the 3 best questions. Return your answer as a JSON object with a single key "questions", which is a list of strings.
        """

    async def select_optimal_questions(self, user_profile: Dict, goal_creation_context: Dict[str, Any]) -> List[Dict]:
        """
        ...
        questions_list = result['content'].get('questions', [])
