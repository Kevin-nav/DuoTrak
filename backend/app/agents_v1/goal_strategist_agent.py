...
class GoalStrategistAgent:
    def __init__(self):
        ...
        **TASK:** Create a comprehensive goal plan in a structured JSON format.
        ...
        - "thought": (String) Your detailed reasoning for why this plan is optimal for this specific user.
    ...
    async def generate_plan(self, user_profile: Dict, goal_creation_context: Dict[str, Any], user_answers: Dict, critique: Optional[Dict] = None) -> (Dict[str, Any], Dict):
        """
        ...
        if not result['success']:
            ...
            # Fallback to a simple plan and create a failure metric object
            fallback_plan = {"title": goal_creation_context['goal_title'], "description": "A simple plan to get you started.", "tasks": []}
            metrics = {"thought": "Fell back to default plan due to Gemini API failure.", "cost": 0, "execution_time": result['execution_time'], "input_tokens": 0, "output_tokens": 0}
