...
export default function DuoStreakHero({
  ...
  return (
    <motion.section
      ...
      className="relative overflow-hidden bg-card rounded-2xl p-8 shadow-sm border border-border"
    >
      {/* Background Pattern */}
      <div className="absolute inset-0 opacity-5">
        <div className="absolute top-4 left-4 w-8 h-8 bg-primary rounded-full"></div>
        <div className="absolute top-12 right-8 w-4 h-4 bg-secondary rounded-full"></div>
        <div className="absolute bottom-8 left-12 w-6 h-6 bg-primary rounded-full"></div>
        <div className="absolute bottom-4 right-4 w-3 h-3 bg-secondary rounded-full"></div>
      </div>
        ...
        <div className="text-center space-y-6">
          ...
          <div className="space-y-2">
            <motion.div
              ...
              className="text-6xl md:text-7xl font-black text-foreground"
            >
              {displayCount}
            </motion.div>
          ...
          <motion.p
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 1 }}
            className="text-muted-foreground font-medium text-lg max-w-md mx-auto"
          >
        ...
        <AnimatePresence>
          {showMilestone && (
            <motion.div
              ...
              className="absolute top-4 left-1/2 transform -translate-x-1/2 bg-gradient-primary text-primary-foreground px-6 py-2 rounded-full shadow-lg"
            >
